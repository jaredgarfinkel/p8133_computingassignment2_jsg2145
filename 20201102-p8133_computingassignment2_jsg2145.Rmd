...
```{r}
design3plus3 = function(n = 6, p = c(0.017, 0.043, 0.1, 0.22, 0.41)) {
  ntox = 0
  i = 1
  j = 1
  l = 1
...
```{r, cache = TRUE}
finl_df1 = design3plus3(n = 1000, p = c(0.10, 0.22, 0.41, 0.64, 0.81))
```
...
```{r, cache = TRUE}
finl_df2 = design3plus3(n = 1000, p = c(0.043, 0.10, 0.22, 0.41, 0.64))
```
...
```{r, cache = TRUE}
finl_df3 = design3plus3(n = 1000, p = c(0.007, 0.017, 0.043, 0.10, 0.22))
```
...
```{r, cache = TRUE}
finl_df4 = design3plus3(n = 1000, p = c(0.003, 0.007, 0.017, 0.043, 0.10))
```
